                ...
                return (
                    <div key={key} className="card col-md-6 col-lg-3  m-4" >
                        ...
                        <div className="card-body">
                            ...
                            <a href="#" className="btn btn-outline-secondary w-100">Rs.{event.pPrice}/=</a>
        ...
        return (
            <div>
                <div id="carouselExampleSlidesOnly" className="carousel " data-ride="carousel">
                    <div className="carousel-inner">
                        <div className="carousel-item active">
                            <img className="d-block w-100" src={require('../../img/banner3.jpg')} alt="First slide" />
                            <div className="carousel-caption d-none d-md-block align-center">
                                <h1 className="drop-shadow" style={{ color: "black" }}>Tours and Travels</h1>
                                <h3 className="drop-shadow" style={{ color: "black" }}>Your Trusted Tour Manager....</h3>
                ...
                <div className="container">
                    <div className="">
                        <h3 className="text-center mt-5">Our Latest Packages...</h3>
