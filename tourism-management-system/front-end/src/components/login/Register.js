    ...
    render() {
        ...
        return (
            ...
            <div className="container">
                ...
                <br /><br />
                <div className="row">
                    <form className="mt-5 col-lg-6 mx-auto" style={{ outlineStyle: "solid", width: "800px", height: "550px", padding: "30px 30px" }} onSubmit={this.handleSubmit}>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="address" onChange={this.handleChange} class="form-control" id="inputEmail3" value={this.state.address} />
                            </div>
                        </div>
                        <div class="form-group row">
